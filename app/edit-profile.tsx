...
const STEP_SUBTITLES = [
  'Update your diet & cuisine preferences',
  'Edit your personal details',
  'Update your body measurements',
  'Change your fitness goal',
  'Update lifestyle & health info',
];
...
export default function EditProfileScreen() {
  ...
  const { profile, updateProfile, updateHealthProfile } = useUserStore();
    ...
    <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      <View style={[styles.screen, { backgroundColor: colors.background }]}>
        ...
        <View style={[styles.header, { paddingTop: insets.top + 12 }]}>
          <TouchableOpacity onPress={() => currentStep > 0 ? setCurrentStep((s) => s - 1) : router.back()} style={styles.navBtn}>
...
const styles = StyleSheet.create({
  ...
  skipText:     { fontSize: Typography.fontSize.sm, fontWeight: '700' },
  ...
  bmiTitle: { fontSize: 10, fontWeight: '700', letterSpacing: 1, textTransform: 'uppercase' },
  ...
  btnText: { fontSize: Typography.fontSize.base, fontWeight: '800', letterSpacing: 0.3 },
});
